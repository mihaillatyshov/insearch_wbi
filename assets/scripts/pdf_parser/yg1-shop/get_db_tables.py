...
from shared import ArgsBase, get_onedrive_path, parse_args

EXPORT_FOLDER = os.path.join(get_onedrive_path(), "Work/wbi/yg1-shop/parsing/bd_tables", "drill_holders.xlsx")
...
constr_list_raw = [
                                                                                                                        ...
                                                                                                                        # "TGI_Module_Holder",
                                                                                                                        # "TSMB_Back_Boring",
                                                                                                                        # "TSMB_tupleBack_Boring",
                                                                                                                        # "TSMB_Chamfer_Preparting",
                                                                                                                        # "TSMB_tupleChamfer_Preparting",
                                                                                                                        # "TSMB_Face_Groove",
                                                                                                                        # "TSMB_tupleFace_Groove",
                                                                                                                        # "TSMB_Radial_DoubleDir",
                                                                                                                        # "TSMB_Radial_FullRound",
                                                                                                                        # "TSMB_tupleRadial_FullRound",
                                                                                                                        # "TSMB_Thread",
                                                                                                                        # "TSMB_tupleThread",
                                                                                                                        # "TSMB_Face_Chamfer",
                                                                                                                        # "TSMB_Face_FullRound",
                                                                                                                        # "TSMB_Multi_Functional",
                                                                                                                        # "TSMB_Radial_Groove",
                                                                                                                        # "TSMB_tupleRadial_Groove",
                                                                                                                        # "TSMB_Turn",
                                                                                                                        # "TSMB_tupleTurn",
                                                                                                                        # "bs_carte",
                                                                                                                        # "tavs_arbor",
...
constr_set = set([f"ctd_{x.lower()}" for x in constr_list_raw])
...
dest_export_path = EXPORT_FOLDER
