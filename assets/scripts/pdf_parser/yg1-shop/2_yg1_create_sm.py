...
from shared import ArgsBase, parse_args, get_onedrive_path

arg_parser = argparse.ArgumentParser(prog='2_yg1_create_sm')
...
fn_args = Args(xlsx_path=os.path.join(get_onedrive_path(), "Work/wbi/yg1-shop/parsing/out_tmp", cmd_args.path),
